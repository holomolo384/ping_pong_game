...
ball = GameSprite("ball.png", 200,200,4,60,60)
racket1 = Player("left_racket.png", 30,200,4,90,90)
racket2 = Player("right_racket.png", 480, 200, 4, 90,90)
...
while game:
    for e in event.get():
        #якщо вихід з гри (клік на кнопку хрестик)
        if e.type == QUIT:
            game = False
    if finish != True:
        window.fill(background)
